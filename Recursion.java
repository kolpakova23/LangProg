...
class Recursion{
	public static void main(String[] args){
		...
		System.out.println("Статическая переменная y ялвяется общей");
		StaticDemo.y = 19;
		System.out.println("Значение StaticDemo.y равен 19");
		System.out.println("ob1.sum: " + ob1.sum());
		System.out.println("ob2.sum: " + ob2.sum());
		System.out.println();
		StaticDemo.y = 190;
                System.out.println("Значение StaticDemo.y равен 190");
                System.out.println("ob1.sum: " + ob1.sum());
                System.out.println("ob2.sum: " + ob2.sum());
		System.out.println();

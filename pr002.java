class pr002{
	public static void main(String args[])
		...
		if (ch == answer)
			...
			if (ch > answer)
				System.out.println("ниже, чем указанная буква");
			else
...
*/
		...
		for(int i = 0; i < 3; i++){
			...
			System.out.print("  Счётчик внутренного цикла: ");
			int t = 0;
			while (t < 100){
				if(t == 10)
					break;
...
three:				{					
				...
				System.out.println("После блок three");
			}
		...
		// Ещё один пример break с меткой
		System.out.println();
done:
		for(int i = 0; i < 10; i++){
			for(int j = 0; j < 10; j++){
